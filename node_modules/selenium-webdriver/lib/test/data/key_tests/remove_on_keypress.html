<!DOCTYPE html>
<div>
	<input id="target" type="checkbox">Pressing "a" while this
	checkbox is focused will remove it from the DOM.
</div>
<div>
	<textarea id="log" style="width: 250px; height: 250px;"></textarea>
</div>
<div>
