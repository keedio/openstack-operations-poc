...
<body style="" name="body">
	...
	<p id="lotsofspaces">This line has lots of spaces.</p>

	<p id="nbsp">This line has a&nbsp;non-breaking space</p>

	<p id="nbspandspaces">This line has a &nbsp; non-breaking space and
		spaces</p>

	<p id="multilinenbsp">
		These lines &nbsp<br />&nbsp have leading and trailing
		NBSPs&nbsp;&nbsp;
	</p>

	<p id="inline">
		This <span id="inlinespan"> line has <em>text</em>
		</span> within elements that are meant to be displayed
		<!-- not as a block but -->
		inline
	</p>
...
document.write(" and with document.write again");
	...
	<form action="resultPage.html">
		<p>
			<input type="checkbox" id="checkbox1"> <label id="label1"
				for="checkbox1">foo<br />bar
			</label>
		</p>
	</form>

	<div id="links">
		<a href=""> link with leading space</a> <a href=""
			id="linkWithTrailingSpace">link with trailing space </a> <a href=""><b>link
				with formatting tags</b></a> <a href="" id="quote">link with " (double
			quote)</a> <a href="" id="squote">link with ' (single quote)</a> <a
			href="" id="backslash">link with \ (backslash)</a>
	</div>

	<div style="text-indent: 80%">
		<a href="resultPage.html" id="multilinelink">this link should
			break<br />on multiple lines
		</a>
	</div>
	...
	<table id="wrappingtext">
		<tbody>
			<tr>
				<td style="width: 10px;"><span>beforeSpace</span><span>
				</span><span>afterSpace</span></td>
			</tr>
		</tbody>
	</table>
