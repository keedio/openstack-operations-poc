...
<body>
	...
	<div id='myDiv'>
		<iframe src="deletingFrame_iframe.html" marginheight="0"
			marginwidth="0" topmargin="0" leftmargin="0" allowtransparency="true"
			frameborder="1" height="200" scrolling="no" width="400" id="iframe1"></iframe>

	</div>
	<div id='myDiv2'></div>
	<input type='button' id='addBackFrame' value='Add back frame'
		onclick='addBack();' />
</body>
</html>
