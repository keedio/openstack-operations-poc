...
<body onload="init()">
	<div>
		<div id="clickJacker" onclick="setOpacity(1);"
			style="position: absolute; float: left; width: 200px; height: 100px; padding: 10px; background-color: darkred; border: 1px solid darkred;">Click
			jacked!</div>
		<div
			style="width: 200px; height: 100px; border: 1px solid black; padding: 10px">Click
			Me</div>
		<script>
    clickJacker = document.getElementById('clickJacker');
  </script>
