...
<body>
	<div>
		<div id="butter" style="background-color: #ffa;"></div>
		<table width="100%">
			<tr valign="top">
				<td width="50%">
					<div>IFRAME</div> <iframe id="editFrame" name="editFrame" src=""
						height="200px" width="300px" frameborder="0"
						style="border: 1px solid black;"> </iframe>
					<div id="editFrameInfo">
						<pre>frame.contentWindow.document.designMode: on<br>frame.contentWindow.document.body.contentEditable: false<br>
						</pre>
					</div>
				</td>
				<td>
					<div>DIV</div>
					<div id="editDiv"
						style="border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; border-top-style: solid; border-right-style: solid; border-bottom-style: solid; border-left-style: solid; border-top-color: black; border-right-color: black; border-bottom-color: black; border-left-color: black; height: 200px; width: 300px; overflow-x: auto; overflow-y: auto; margin-top: 1px; margin-right: 1px; margin-bottom: 1px; margin-left: 1px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px;"
						contenteditable="true"></div>
					<div id="editDivInfo">
						<pre>div.ownerDocument.designMode: off<br>div.ownerDocument.body.contentEditable: false<br>div.contentEditable: true<br>
						</pre>
					</div>
				</td>
			</tr>
	...
	<HR>
	<DIV
		style="margin: 0px; padding: 0px; padding-left: 10px; font-family: Courier;">
		<TABLE cellpadding="0" cellspacing="0" width="200px"
			style="font-size: 9pt;">
			<TBODY>
				<TR>
					<TD width="110px">type:</TD>
					<TD id="type" width="90px">[]</TD>
				</TR>
				<TR>
					<TD>tagName:</TD>
					<TD id="tagName">[]</TD>
				...
				<TR>
					<TD>keyIdentifier:</TD>
					<TD id="keyidentifier">[]</TD>
				</TR>
				<TR>
					<TD>keyLocation:</TD>
					<TD id="keylocation">[]</TD>
				</TR>
				<TR>
					<TD>keyCode:</TD>
					<TD id="keycode">[]</TD>
