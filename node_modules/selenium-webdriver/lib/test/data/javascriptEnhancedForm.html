...
<body>
	<form id="form1" action="javascriptEnhancedForm.html" method="post">
		<p>
			<label id="labelforusername" for="username"> Username: <input
				id="username" type="text" name="username" /> <script
		...
		<p>
			<label for="password"> Password: <input id="password"
				type="password" name="password" /> <script type="text/javascript">
